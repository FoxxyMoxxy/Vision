...
#
# See https://github.com/capergroup/vision/issues/166
#
...
java $BOOT_CLASSPATH -DconfigurationFile=$SCRIPT_DIR/resources/conf/apiSynthesisServerConfig.properties -Dlog4j.configurationFile=$SCRIPT_DIR/resources/conf/apiSynthesisServerLog4j2.xml -jar $VISION_JAR &
...
python3 $SCRIPT_DIR/python/vision/server/ast_server.py --save_dir "$SCRIPT_DIR/resources/model" --logs_dir "$LOGS_DIR"
