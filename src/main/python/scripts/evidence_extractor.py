...
def extract_evidence(clargs):
    ...
    for program in js['programs']:
        ...
        apicalls = list(set(chain.from_iterable([vision.models.low_level_evidences.evidence.APICalls.from_call(call)
                                                 for call in calls])))
        types = list(set(chain.from_iterable([vision.models.low_level_evidences.evidence.Types.from_call(call)
                                              for call in calls])))
        keywords = list(set(chain.from_iterable([vision.models.low_level_evidences.evidence.Keywords.from_call(call)
                                                for call in calls])))
