...
import vision.experiments.low_level_sketches.evidence
...
def read_config(js, save_dir, infer=False):
    ...
    config.evidence = vision.experiments.low_level_sketches.evidence.Evidence.read_config(js['evidence'], save_dir)
