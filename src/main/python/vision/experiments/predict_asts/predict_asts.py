...
import vision.experiments.low_level_sketches.infer
import vision.experiments.nonbayesian.infer
...
def main(clargs):
    ...
    with tf.Session() as sess:
        if clargs.model == 'bayesian':
            p_type = vision.models.core.infer.BayesianPredictor
        elif clargs.model == 'nonbayesian':
            p_type = vision.experiments.nonbayesian.infer.NonBayesianPredictor
        elif clargs.model == 'low_level_evidences':
            p_type = vision.models.low_level_evidences.infer.BayesianPredictor
        elif clargs.model == 'low_level_sketches':
            p_type = vision.experiments.low_level_sketches.infer.BayesianPredictor
        else:
