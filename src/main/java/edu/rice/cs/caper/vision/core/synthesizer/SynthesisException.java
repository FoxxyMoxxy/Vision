...
public class SynthesisException extends RuntimeException {
    ...
    static {
        ...
        _toMessage.put(CouldNotResolveBinding,
                "Vision could not resolve the reference of the method %s");
        ...
        _toMessage.put(CouldNotEditDocument,
                "Vision internal error: could not edit document for some reason.");
        ...
        _toMessage.put(MalformedASTFromNN,
                "Vision internal error: Malformed AST predicted by neural network.");
        _toMessage.put(TypeParseException,
                "Vision internal error: Malformed type from AST.");
