...
import edu.rice.cs.caper.vision.core.lexer.ccll._1_0.*;
import edu.rice.cs.caper.vision.core.parser.evidencel._1_0.*;
 ...
 * Java method invocations from class in edu.rice.cs.caper.vision.annotations.Evidence.
 */
public class ApiSynthesizerRewriteEvidenceDecorator implements ApiSynthesizer
{
    ...
    // replace instances of /// in code with calls to methods in edu.rice.cs.caper.vision.annotations.Evidence.
    ...
    // attempt to determine the corresponding edu.rice.cs.caper.vision.annotations.Evidence call from the
    // /// short hand notation.
    static String makeEvidenceFromComment(String tripleSlashComment) throws ParseException
    {
        ...
        for(EvidenceElement element : root.getElements())
        {
            ...
            // edu.rice.cs.caper.vision.annotations.Evidence.apicalls(
            // or
            // edu.rice.cs.caper.vision.annotations.Evidence.types(
            try
            {
    ...
    private static String determineEvidenceType(EvidenceElement element) throws UnknownType
    {
        ...
        String type = element.match(new EvidenceElementCases<String, UnknownType>()
        {
            ...
            {
                return "edu.rice.cs.caper.vision.annotations.Evidence.keywords(\"";
            }
            ...
            public String forWithTypeIdent(EvidenceElementWithTypeIdentifierNode evidenceElement) throws UnknownType
            {
                ...
                switch (typeIdent)
                {
                    case "call":
                    case "calls":
                        return "edu.rice.cs.caper.vision.annotations.Evidence.apicalls(\"";
                    case "type":
                    case "types":
                        return "edu.rice.cs.caper.vision.annotations.Evidence.types(\"";
                    default:
