...
import edu.rice.cs.caper.vision.core.synthesizer.EvidenceExtractor;
import edu.rice.cs.caper.vision.core.synthesizer.ParseException;
import edu.rice.cs.caper.vision.core.synthesizer.Parser;
import edu.rice.cs.caper.vision.core.synthesizer.Synthesizer;
...
public class ApiSynthesizerRemoteTensorFlowAsts implements ApiSynthesizer
{
    ...
    /**
     * A classpath string that includes the class edu.rice.cs.caper.vision.annotations.Evidence.
     */
     ...
     * @param evidenceClasspath A classpath string that includes the class edu.rice.cs.caper.vision.annotations.Evidence.
*                          May not be null.
