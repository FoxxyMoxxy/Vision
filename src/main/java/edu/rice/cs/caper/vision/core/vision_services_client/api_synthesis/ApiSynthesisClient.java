...
*/
package edu.rice.cs.caper.vision.core.vision_services_client.api_synthesis;

import edu.rice.cs.caper.vision.core.vision_services_client.JsonMsgClientBase;
...
public class ApiSynthesisClient extends JsonMsgClientBase
{
    ...
    private List<String> synthesizeHelp(String code, int maxProgramCount, Integer sampleCount) throws IOException, SynthesisError
    {
        ...
        post.addHeader("Origin", "http://askvision.com");
