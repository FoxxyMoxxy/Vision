...
*/
package edu.rice.cs.caper.vision.application.api_synthesis_server.servlet;

import edu.rice.cs.caper.vision.application.api_synthesis_server.Configuration;
import edu.rice.cs.caper.vision.application.api_synthesis_server.synthesis.ApiSynthesizer;
import edu.rice.cs.caper.vision.application.api_synthesis_server.synthesis.ApiSynthesizerEcho;
import edu.rice.cs.caper.vision.application.api_synthesis_server.synthesis.ApiSynthesizerRemoteTensorFlowAsts;
...
class ApiSynthesizerFactory
{
    ...
    /**
     * @return a synthesiser in accordance with edu.rice.cs.caper.vision.application.api_synthesis_server.Configuration
     */
