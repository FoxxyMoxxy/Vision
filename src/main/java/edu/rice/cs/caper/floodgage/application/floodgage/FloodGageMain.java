...
import edu.rice.cs.caper.floodgage.application.floodgage.synthesizer.SynthesizerVision_1_1_0;
...
public class FloodGageMain
{
    public static void main(String[] args) throws Exception
    {
        ...
        if(args.length != 1)
        {
            System.out.println("Usage: java -cp [trails.jar]:[floodgage.jar] [vision-hostname]");
            return;
        }

        String visionHostname = args[0];
        SynthesizerVision_1_1_0 synthesizer = new SynthesizerVision_1_1_0(visionHostname, 8080);
