 ...
 * placeholders with "triple slash" evidence strings (conforming to Vision 1.1.0's expected "hole" format) upon
 ...
 *
 * Upon invocation of buildDraft, the builder would replace placeholders like "/// 1" with the corresponding Vision
 * holes:
 *
 *
 *     public class Foo
 ...
 */
public class DraftBuilderVision1_1_0 implements DraftBuilder
{
    /*
     ...
     */
    public DraftBuilderVision1_1_0(String protoDraft)
    {
        if(protoDraft == null)
    ...
    public String buildDraft()
    {
        ...
        {
            /*
             * Build the Vision 1.1.0 evidence hole using the evidence associated with id.
             */
    ...
    /*
     * Return the Vision 1.1.0 evidence "tripple slash notation" form of evidence.
     */
