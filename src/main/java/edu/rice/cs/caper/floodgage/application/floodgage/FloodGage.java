...
import edu.rice.cs.caper.floodgage.application.floodgage.draft_building.DraftBuilderVision1_1_0;
...
class FloodGage
{
    ...
    void run(Synthesizer synthesizer, View view) throws IOException, ParseException, ClassNotFoundException
    {
        ...
        {
            List<Trial> trials = makeTrials(directive, DraftBuilderVision1_1_0::new);
            ...
            throws IOException
    {
        ...
        for(edu.rice.cs.caper.floodgage.application.floodgage.model.directive.Trial trial : directive.getTrials())
        {
             ...
             *
             *     For example, with Vision 1.1.0 that would be (with the trials.xml above)
             *
             *     import java.util.function.*;
             *
             *     public class ReadFileLinesDraft implements Consumer<String>
