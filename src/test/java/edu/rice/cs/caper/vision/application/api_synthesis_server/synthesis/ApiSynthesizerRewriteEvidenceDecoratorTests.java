...
*/
package edu.rice.cs.caper.vision.application.api_synthesis_server.synthesis;

import edu.rice.cs.caper.vision.core.lexer.UnexpectedEndOfCharacters;
import edu.rice.cs.caper.vision.core.parser.evidencel._1_0.ParseException;
...
public class ApiSynthesizerRewriteEvidenceDecoratorTests
{
    ...
    public void testSynthesize2() throws SynthesiseException
    {
        ...
        String correct = "preable edu.rice.cs.caper.vision.annotations.Evidence.keywords(\"foo\");\n afterword";
    ...
    public void rewriteEvidenceBluetooth() throws UnexpectedEndOfCharacters, ParseException
    {
        String program =
                "import android.bluetooth.BluetoothAdapter;\n" +
                        "\n" +
                        "// Vision supports three types of evidence:\n" +
        ...
        String correct =
                "import android.bluetooth.BluetoothAdapter;\n" +
                        ...
                        "        { // Provide evidence within a separate block\n" +
                        "            // Code should call \"getInputStream\"...\n" +
                        "            edu.rice.cs.caper.vision.annotations.Evidence.apicalls(\"getInputStream\");\n" +
                        "            // ...on a \"BluetoothSocket\" type\n" +
                        "            edu.rice.cs.caper.vision.annotations.Evidence.types(\"BluetoothSocket\");\n" +
                        "        } // Synthesized code will replace this block\n" +
                        "    }\n" +
                        "\n" +
                        "}\n";
    ...
    public void rewriteEvidenceCamera() throws UnexpectedEndOfCharacters, ParseException
    {
        ...
        String correct =
                "import edu.rice.cs.caper.vision.annotations.Evidence;\n" +
                        ...
                        "        { // Provide evidence within a separate block\n" +
                        "            // Code should call \"startPreview\"...\n" +
                        "            edu.rice.cs.caper.vision.annotations.Evidence.apicalls(\"startPreview\");\n" +
                        "        } // Synthesized code will replace this block\n" +
                        "    }   \n" +
                        "\n" +
                        "}\n";
    ...
    public void rewriteEvidenceDialog() throws UnexpectedEndOfCharacters, ParseException
    {
        ...
        String correct =
                "import edu.rice.cs.caper.vision.annotations.Evidence;\n" +
                        ...
                        "        { // Provide evidence within a separate block\n" +
                        "            // Code should call \"setTitle\" and \"setMessage\"...\n" +
                        "            edu.rice.cs.caper.vision.annotations.Evidence.apicalls(\"setTitle\", \"setMessage\");\n" +
                        "            // ...on an \"AlertDialog\" type\n" +
                        "            edu.rice.cs.caper.vision.annotations.Evidence.types(\"AlertDialog\");\n" +
                        "        } // Synthesized code will replace this block\n" +
                        "    }   \n" +
                        "\n" +
                        "}\n";
    ...
    public void rewriteEvidenceIO1() throws UnexpectedEndOfCharacters, ParseException
    {
        ...
        String correct =
                "import edu.rice.cs.caper.vision.annotations.Evidence;\n" +
                        ...
                        "        { // Provide evidence within a separate block\n" +
                        "            // Code should call \"readLine\"\n" +
                        "            edu.rice.cs.caper.vision.annotations.Evidence.apicalls(\"readLine\");\n" +
                        "        } // Synthesized code will replace this block\n" +
                        "    }   \n" +
                        "\n" +
                        "}\n";
    ...
    public void rewriteEvidenceIO3() throws UnexpectedEndOfCharacters, ParseException
    {
        ...
        String correct =
                "import edu.rice.cs.caper.vision.annotations.Evidence;\n" +
                        ...
                        "        String file;\n" +
                        "        {\n" +
                        "            edu.rice.cs.caper.vision.annotations.Evidence.apicalls(\"readLine\", \"printStackTrace\", \"close\");\n" +
                        "        }\n" +
                        "    }   \n" +
                        "}\n";
    ...
    public void rewriteEvidenceSpeech() throws UnexpectedEndOfCharacters, ParseException
    {
        ...
        String correct =
                "import edu.rice.cs.caper.vision.annotations.Evidence;\n" +
                        ...
                        "        { // Provide evidence within a separate block\n" +
                        "            // Code should make API calls on \"SpeechRecognizer\"...\n" +
                        "            edu.rice.cs.caper.vision.annotations.Evidence.types(\"SpeechRecognizer\");\n" +
                        "        } // Synthesized code will replace this block\n" +
                        "    }   \n" +
                        "\n" +
                        "}\n";
    ...
    public void rewriteEvidenceWifi() throws UnexpectedEndOfCharacters, ParseException
    {
        ...
        String correct =
                "import edu.rice.cs.caper.vision.annotations.Evidence;\n" +
                        ...
                        "        { // Provide evidence within a separate block\n" +
                        "            // Code should call \"startScan\"...\n" +
                        "            edu.rice.cs.caper.vision.annotations.Evidence.apicalls(\"startScan\");\n" +
                        "            // ...on a \"WifiManager\" type\n" +
                        "            edu.rice.cs.caper.vision.annotations.Evidence.types(\"WifiManager\");\n" +
                        "        } // Synthesized code will replace this block\n" +
                        "\n" +
                        "    }   \n" +
                        "\n" +
    ...
    public void testMakeEvidenceFromCommentFreeform() throws ParseException
    {
        ...
        Assert.assertEquals("edu.rice.cs.caper.vision.annotations.Evidence.keywords(\"foo\");\n", result);
    }
    ...
    public void testMakeEvidenceFromCommentFreeform2() throws ParseException
    {
        ...
        Assert.assertEquals("edu.rice.cs.caper.vision.annotations.Evidence.keywords(\"foo\", \"bar\");\n", result);
    }
    ...
    public void testMakeEvidenceFromCommentCall() throws ParseException
    {
        ...
        Assert.assertEquals("edu.rice.cs.caper.vision.annotations.Evidence.apicalls(\"foo\");\n", result);
    }
    ...
    public void testMakeEvidenceFromCommentCalls2() throws ParseException
    {
        ...
        Assert.assertEquals("edu.rice.cs.caper.vision.annotations.Evidence.apicalls(\"foo\", \"bar\");\n", result);
    }
    ...
    public void testMakeEvidenceFromCommentType() throws ParseException
    {
        ...
        Assert.assertEquals("edu.rice.cs.caper.vision.annotations.Evidence.types(\"foo\");\n", result);
    }
    ...
    public void testMakeEvidenceFromCommentTypes2() throws ParseException
    {
        ...
        Assert.assertEquals("edu.rice.cs.caper.vision.annotations.Evidence.types(\"foo\", \"bar\");\n", result);
    }
